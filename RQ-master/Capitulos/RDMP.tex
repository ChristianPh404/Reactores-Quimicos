...
\qs{RDMP-2021-O}{El equilibrio químico
	...
	se lleva a cabo durante 120 h en un reactor discontinuo mezcla perfecta de 1 m$^3$ que contiene inicialmente 1 kmol/m$^3$ del compuesto A y 1.5 kmol/m$^3$ del compuesto B a 320 K. El reactor dispone de una camisa de 5 m$^2$ a 300 K con un coeficiente global de transmisión de calor de 1.5 kcal/(m$^2\cdot$h$\cdot$K).

	Considerando para la mezcla reaccionante una densidad de 1200 kg/m$^3$ y una capacidad calorífica de 0.9 kcal/(kg$\cdot$K):
