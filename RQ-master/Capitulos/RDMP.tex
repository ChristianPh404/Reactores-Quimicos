...
\end{equation}
En la etapa de diseño la masa dará el volumen y el balance entálpico como la temperatura es constante dará el diseño del intercambiador de calor.
Por tanto el objetivo a calcular es el tiempo de residencia.
\begin{equation}
	\frac{dN_A}{dt} = -r_A \cdot V
\end{equation}
Para transformar en conversión:
\begin{equation}
	X_A = \frac{N_{AR}-N_A}{N_{AR}} \rightarrow N_A = N_{AR} \cdot (1-X_A)
\end{equation}
\begin{equation}
...
\nt{Productividad = moles producto deseado /m3/s el tiempo de productividad depende del ciclo no es el de operación del reactor, sino que
