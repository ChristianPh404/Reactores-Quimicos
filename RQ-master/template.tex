...
\usepackage{multirow}
\usepackage{tikz}
\usetikzlibrary{arrows.meta, positioning, calc, decorations.pathreplacing, babel}
\usepackage{amsmath}
\usepackage{minted}
\usepackage{csquotes}
...
\title{\Huge{Reactores Químicos}\\Teoría y Ordenador}
...
\include{Capitulos/RDMP}
\include{Capitulos/RCMP}
\include{Capitulos/RCFP}
\include{Capitulos/RSMP}
\include{Capitulos/Reactor_real}
