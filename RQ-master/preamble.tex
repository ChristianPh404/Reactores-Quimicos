...
{\addvspace{1pt}\small\contentsmargin{2.5em}} % Espaciado más limpio
{\thecontentslabel\quad} % Mostrar número de subsección (1.1.1, 1.1.2)
{}
{\titlerule*[1pc]{.}\contentspage} % Alinear el número de página correctamente con puntos

\titlecontents{subsubsection}[6pc] % Mayor indentación para subsubsecciones
{\addvspace{0pt}\footnotesize\contentsmargin{2.5em}}
